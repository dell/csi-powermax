...
export X_CSI_POWERMAX_NODENAME=`hostname -s`
...
export X_CSI_POWERMAX_PORTGROUPS="csi_pg2"
...
export SYMID="000120000548"
export SRPID="SRP_1"
export SERVICELEVEL="Bronze"
export LOCALRDFGROUP="280"
export REMOTESYMID="000120000549"
export REMOTESRPID="SRP_1"
export REMOTESERVICELEVEL="Bronze"
export X_CSI_ENABLE_BLOCK="true"
export REMOTERDFGROUP="281"
