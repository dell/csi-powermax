...
...
   quay.io/dell/container-storage-modules/csi-powermax:v2.17.0
...
...
Loaded image: quay.io/dell/container-storage-modules/csi-powermax:v2.17.0
...

*
* Tagging and pushing images

   quay.io/dell/container-storage-modules/csi-powermax:v2.17.0 -> localregistry:5000/dell-csm-operator/csi-powermax:v2.17.0
   ...

*
* Preparing files within /root/dell-csm-operator-bundle

   changing: quay.io/dell/container-storage-modules/csi-powermax:v2.17.0 -> localregistry:5000/dell-csm-operator/csi-powermax:v2.17.0
   ...
