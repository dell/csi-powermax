...
./modify_zoning_labels.sh add zone.csi-powermax.dellemccom=zoneA zone.csi-powermax.dellemc.com=zoneB
./modify_zoning_labels.sh add zone.region.csi-powermax.dellemc.com=zoneC zone.region.csi-powermax.dellemc.com=zoneD
